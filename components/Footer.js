...
const Footer = () => {
  return (
    <footer className=" px-4 divide-y fotterbg dark:bg-gray-800 dark:text-gray-100">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<Link rel="noopener noreferrer" href="/" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl Filmotrend font-semibold">FilmyCommerce</span>
			</Link>
		</div>
