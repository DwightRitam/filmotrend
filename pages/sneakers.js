...
import {  addsneakers, getsneakers, } from '../redux/slice'
...
const jeans = () => {
  ...
  useEffect(() => {
    ...
    fetch("https://filmotrendbyritam.vercel.app/api/getsneakers")
    .then((response) => response.json())
    .then((data) =>dispatch(addsneakers(data.sneakers)));
  ...
  return (
    ...
    <div className="  p-3 herodesbg  space-y-8  ">
      <div className="space-y-2 text-center">
			<h2 className="text-3xl font-bold mt-[2rem]">All the trendy Sneakers of of top notch brand is out here</h2>
