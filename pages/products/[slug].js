...
import { addcartdetails, getaddcartdetails } from '../../redux/slice'
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <p className="leading-relaxed">{cartvalues.desc}</p>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">{cartvalues.price}</span>
