...
import { addsweatshirts, addtshirts, getswatshirts, gettshirts } from '../redux/slice'
...
const sweatshirts = () => {
  ...
  const sweatshirtsvalues=useSelector(getswatshirts)
  // console.log(sweatshirtsvalues);
